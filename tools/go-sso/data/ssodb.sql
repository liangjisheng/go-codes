...
ALTER TABLE `device` ADD PRIMARY KEY (`id`), ADD KEY `uid` (`uid`);
ALTER TABLE `device` MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键';
...
ALTER TABLE `trace` ADD PRIMARY KEY (`id`), ADD KEY `UT` (`uid`, `type`) USING BTREE;
ALTER TABLE `trace` MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键', AUTO_INCREMENT=2;
...
ALTER TABLE `users` ADD PRIMARY KEY (`id`), ADD KEY `ctime` (`ctime`);
ALTER TABLE `users` MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键';
