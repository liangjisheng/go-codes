...
// StrToTime1 等同于PHP的strtotime函数
// StrToTime1("2020-12-19 14:16:22")
func StrToTime1(value string) (t time.Time, err error) {
	if value == "" {
