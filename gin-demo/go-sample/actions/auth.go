...
// 1.可以对&转义 \&
// curl -s -X POST http://127.0.0.1:8080/login?name=alice\&password=123456
// 用双引号把整个url引起来
// curl -X POST "http://127.0.0.1:8080/login?name=alice&password=123456"
...
// Register ...
// curl http://127.0.0.1:8080/register -X POST -d 'name=alice&email=example@qq.com&password=123456&password_confirmation=123456'
