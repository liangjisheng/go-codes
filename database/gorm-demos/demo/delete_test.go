...
func TestDeleteUser(t *testing.T) {
	...
	// 带额外条件的删除
	db.Where("name = ?", "ljs").Delete(&user)
	// DELETE from emails where id = 3 AND name = "ljs";
	...
	db.Where("email LIKE ?", "%ljs%").Delete(&User{})
	// DELETE from emails where email LIKE "%ljs%";

	db.Delete(&User{}, "email LIKE ?", "%ljs%")
	// DELETE from emails where email LIKE "%ljs%";
